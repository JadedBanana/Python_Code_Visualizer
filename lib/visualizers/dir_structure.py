...
def generate_graph_nodes_recursive(parent_folder, rel_folder, graph):
    ...
    # Make this folder's node.
    graph.add_node(parent_node_name, weight=math.sqrt(folder_bytes_total + 1), size=math.sqrt(folder_bytes_total + 1))
